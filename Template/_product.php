                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <!---    product price       -->
                            <table class="my-3">
                                ...
                                <tr class="font-rale font-size-14">
                                    <td>You Save:</td>
                                    <td><span class="font-size-16 text-danger">$<?php echo 162.00-$item['item_price'] ?? 152; ?></span></td>
                                </tr>
                            </table>
                         <!--    #policy -->
                            <div id="policy">
                                <div class="d-flex">
                                    ...
                                    <div class="return text-center mr-5">
                                        ...
                                        <a href="#" class="font-rale font-size-12">Home Delivery</a>
                                    </div>
                                    <div class="return text-center mr-5">
                                        <div class="font-size-20 my-2 color-second">
                        ...
                        <!-- order-details -->
                            <div id="order-details" class="font-rale d-flex flex-column text-dark">
                                <small>Delivery three days after order</small>
                                <small>Sold by 180 Memes(4.5 out of 5 | 18,198 ratings)</small>
                                <small><i class="fas fa-map-marker-alt color-primary"></i>&nbsp;&nbsp;Delivered to Customer - 424201</small>
                            </div>
                         <div class="row">
                             <div class="col-6">
                                    <!-- color -->
